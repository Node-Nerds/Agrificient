                                      ...
                                      if (res.rowCount == 0) {
                                          ...
                                          if (res.rowCount == 0) {
                                            ...
                                            .then((res) => {
                                              ...
                                              if (res.rowCount == 0) {
                                                ...
                                                query =  "CREATE TABLE if not exists public.aggregator(    id uuid NOT NULL DEFAULT uuid_generate_v4(),    user_id uuid NOT NULL,    aggregator_name character varying(255)  ,    phone character varying(10)  ,    latitude numeric(100,10),    longitude numeric(100,10),    pincode numeric(6,0),    address character varying(255)  ,    description character varying(10000)  ,    whatsapp character varying(255)  )"
                                        ...
                                        .then((res) => {
                                          ...
                                          if (res.rowCount == 0) {
                                            ...
                                            query =  "CREATE TABLE if not exists public.proposal(    warehouse_id uuid NOT NULL,    user_id uuid NOT NULL,    start_date date NOT NULL,    end_date date NOT NULL,    quantity numeric(1000,0),    id uuid NOT NULL DEFAULT uuid_generate_v4(),    current_status public.status DEFAULT 'pending'::public.status)"
                                        ...
                                        .then((res) => {
                                          ...
                                          if (res.rowCount == 0) {
                                            ...
                                            query =  "CREATE TABLE if not exists public.warehouse(    id uuid NOT NULL DEFAULT uuid_generate_v4(),    user_id uuid NOT NULL,    warehouse_name character varying(255)  ,    phone character varying(10)  ,    latitude numeric(100,10),    longitude numeric(100,10),    pincode numeric(6,0),    address character varying(255)  )"
                                ...
                                client
                                  ...
                                  .then((res) => {
                                    ...
                                    if (res.rowCount == 0) {
                                      ...
                                      let query  = "CREATE TYPE public.status AS ENUM ('pending', 'approved', 'paid');"
                                      client
                                        .query(query)
                                        .then((res) => {
                                          // console.log(res);
